...
| A4 | WorldPop/GHSL population estimates are acceptable proxies for population distribution (they are model-based, not census) | RESOLVED — 2014 Census used | Superseded: pipeline now uses official 2014 Census township totals (DoP / MIMU), which also provide township-level age structure |
