...
|---|---|---|---|---|---|
| City government (Yangon City Development Committee / other ASEAN cities) | Decision-maker, land-use & infrastructure planner | District budgets, drainage plans, urban plans | Prioritised flood-risk map to target drainage and zoning | Adopt risk rankings into planning; maintain updated boundary/census data | Needs stable open-data releases; political will |
| National disaster-management agency (e.g. NDMO Myanmar, BNPB Indonesia) | Emergency preparedness and response | National flood event records, disaster loss data | Where/who/what is most exposed; seasonal hazard windows | Use exposure maps for preparedness planning and resource pre-positioning | Needs flood-extent validation data sharing |
| National meteorological agency (DMH Myanmar / BMKG / PAGASA / TMD / MET Malaysia) | Hazard data authority | Gauge rainfall, forecasts | Visibility into how their data supports urban risk analytics | Publish/verify rainfall records; validate CHIRPS against gauges | Needs sustained station maintenance and open access |
